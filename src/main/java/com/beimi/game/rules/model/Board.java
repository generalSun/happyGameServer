...
public abstract class Board implements Message,java.io.Serializable {
	...
	private int dzCardPlayerIndex;//切到地主牌玩家编号
	private Player dzCardPlayer;//切到地主牌玩家
	...
	public int getDzCardPlayerIndex() {
		return dzCardPlayerIndex;
	}
	public void setDzCardPlayerIndex(int index) {
		this.dzCardPlayerIndex = index;
	}

	public Player getDzCardPlayer() {
		return dzCardPlayer;
	}
	public void setDzCardPlayer(Player dzCardPlayer) {
		this.dzCardPlayer = dzCardPlayer;
	}
	/**
	 * 找到玩家数据
	 * @param userid
	...
	public int getCatchPlayerNum() {
		return catchPlayerNum;
	}
	public void setCatchPlayerNum(int catchPlayerNum) {
		this.catchPlayerNum = catchPlayerNum;
	}
