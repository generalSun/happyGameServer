package com.beimi.config.game.dizhu;
...
import com.beimi.game.dizhu.action.AutoAction;
import com.beimi.game.dizhu.action.CatchAction;
import com.beimi.game.dizhu.action.RaiseHandsAction;
import com.beimi.game.dizhu.action.PlayCardsAction;
        ...
        states
            .withStates()
                .initial(BeiMiGameEnum.NONE.toString())
                    ...
                    .state(BeiMiGameEnum.CATCH.toString())
                    .state(BeiMiGameEnum.LASTHANDS.toString())
