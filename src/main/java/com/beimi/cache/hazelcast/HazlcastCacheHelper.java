package com.beimi.cache.hazelcast;

import com.beimi.core.BMDataContext;
import com.beimi.cache.CacheBean;
import com.beimi.cache.CacheInstance;
import com.beimi.cache.PlayerCacheBean;
import com.beimi.cache.hazelcast.impl.ApiUserCache;
import com.beimi.cache.hazelcast.impl.GameCache;
import com.beimi.cache.hazelcast.impl.GameRoomCache;
import com.beimi.cache.hazelcast.impl.OnlineCache;
import com.beimi.cache.hazelcast.impl.QueneCache;
import com.beimi.cache.hazelcast.impl.SystemCache;
/**
 * Hazlcast缓存处理实例类
 * @author admin
 *
