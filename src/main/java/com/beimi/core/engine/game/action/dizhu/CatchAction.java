...
import com.beimi.core.engine.game.task.dizhu.CreateCatchTask;
 ...
 *
 */
public class CatchAction<T,S> implements Action<T, S>{
	@Override
	public void execute(Message<T> message , BeiMiExtentionTransitionConfigurer<T,S> configurer) {
		...
		if(!StringUtils.isBlank(room)){
			...
			if(gameRoom!=null){
				...
				CacheHelper.getExpireCache().put(gameRoom.getRoomid(), new CreateCatchTask(interval , gameRoom , gameRoom.getOrgi()));
			}
		}
	}
}
